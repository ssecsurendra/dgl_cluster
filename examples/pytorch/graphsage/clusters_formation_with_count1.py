...
if __name__ == "__main__":
    ...
    #for j in clusters:
        #print(j)
    file_path = '/data/surendra/workspace/dgl_cluster/python/dgl/sampling/cluster1/clusters.txt'
    ...
    file_path1 = '/data/surendra/workspace/dgl_cluster/python/dgl/sampling/cluster1/cluster_id.pt'
    ...
    #print(cluster_id)
    cluster_id = cluster_id.tolist()
    file_path4 = '/data/surendra/workspace/dgl_cluster/python/dgl/sampling/cluster1/cluster_id.txt'
    with open(file_path4, "w") as file:
    ...
    #for j, row in enumerate(representative):
        ...
        #print(row)
    file_path2 = '/data/surendra/workspace/dgl_cluster/python/dgl/sampling/cluster1/representative.pt'
