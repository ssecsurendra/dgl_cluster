...
set output 'gcn_15.eps'
set boxwidth 0.9 absolute
set style fill solid 1.00 border lt -1
# Set the legend (key) font
set key inside top left vertical font "Arial,45"  # Adjust the font size as needed
# Set the labels (no title)
set tmargin 2
set xlabel "Dataset" font "Arial,45 italic bold" offset 0,-2
set bmargin 6
set ylabel "Total Time(Seconds)" font "Arial,45 italic bold" offset -4
set lmargin 15
...
#set xtics nomirror
set xtics font "Arial,45 italic bold" offset 0,-1
...
plot 'gcn_15.txt' using 2:xtic(1) title 'GraphSAGE' lt rgb "skyblue", \
