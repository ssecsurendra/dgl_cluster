...
set output 'loss_plot_igb-small.eps'
...
set bmargin 4 
set ylabel "Loss" font "Arial,45 italic bold"
#set lmargin 15
...
plot 'loss_line_igb-small.txt' using 0:1 every ::2 with linespoints title 'CLING' lw 1 pt 12, \
     '' using 0:2 every ::2 with linespoints title 'DGL' lw 1 pt 12, \
     #'' using 0:3 every ::2 with linespoints title 'FastGL' lw 3 pt 12, \
