...
set output 'igb-small_batch_F15.eps'
...
#set xtics nomirror
set xtics font "Arial,50 italic bold"
set ytics font "Arial,50 italic bold"
...
plot 'igb-small_batch_15.txt' using 2:xtic(1) title 'DGL' lt rgb "skyblue", \
