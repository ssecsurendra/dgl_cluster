...
set output 'Memory_usage_product.eps'
...
set bmargin 4 
set ylabel "Memory Usage (MB)" font "Arial,45 italic bold" offset -1
set lmargin 10
...
plot 'Memory_usage_product.txt' using 0:1 every ::2 with linespoints title 'CLING' lt 1 lw 2 lc rgb 'blue' pt 2, \
