...
def train(dataset, args):
    ...
    train_seedloader = SeedGenerator(train_nid, batch_size=args.batchsize, shuffle=True, drop_last=False)
    val_seedloader = SeedGenerator(val_nid, batch_size=args.batchsize, shuffle=True, drop_last=False)
...
if __name__ == "__main__":
    ...
    #parser.add_argument("--samples", default="20,10", help="sample size for each layer")
